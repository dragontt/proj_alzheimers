...
switch (lower(Render))
    ...
    case 'gotracer color render'
        for i=1:length(Skel)
            ...
            L2=fnplt(cscvn(L));
            if Skel{2,i}==1
                plot3(L2(1,:),L2(2,:),L2(3,:),'Color',[0,0,.25],'LineWidth',3);
            elseif Skel{2,i}==2
                plot3(L2(1,:),L2(2,:),L2(3,:),'Color',[.25,0,0],'LineWidth',3);
            elseif Skel{2,i}==3
                plot3(L2(1,:),L2(2,:),L2(3,:),'Color',[0,0,.85],'LineWidth',3);
            elseif Skel{2,i}==4
                plot3(L2(1,:),L2(2,:),L2(3,:),'Color',[.85,0,0],'LineWidth',3);
            else
